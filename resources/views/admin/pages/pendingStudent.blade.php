  ...
  <tbody>
      @if($pendingStudentList)
            ...
            <tr>
                ...
                <td>
               <!-- Edit  -->
            <a href="{{ url('update-pendingStudent/'.$psl->id) }}" class="btn btn-success" data-toggle="modal" data-target="#myModal2{{$psl->id}}">Approve</a>
              <!-- The Modal -->
             ...
             <!-- Delete -->
              <a href="{{ url('delete-pendingStudent/'.$psl->id) }}" class="btn btn-danger" data-toggle="modal" data-target="#myModal{{$psl->id}}">Delete</a>
              <!-- The Modal -->
