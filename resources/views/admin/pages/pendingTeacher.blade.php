  ...
  <tbody>
      @if($pendingTeacherList)
            ...
            <tr>
                ...
                <td>
               <!-- Edit  -->
            <a href="{{ url('update-pendingTeacher/'.$ptl->id) }}" class="btn btn-success" data-toggle="modal" data-target="#myModal2{{$ptl->id}}">Approve</a>
              <!-- The Modal -->
             ...
             <!-- Delete -->
              <a href="{{ url('delete-pendingTeacher/'.$ptl->id) }}" class="btn btn-danger" data-toggle="modal" data-target="#myModal{{$ptl->id}}">Delete</a>
              <!-- The Modal -->
